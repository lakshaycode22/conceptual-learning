...
const Results = () => {
  ...
  return (
    <div class="mx-auto max-w-7xl my-8 md:mb-0 px-6">
                ...
                >
                  <div class=" rounded-lg">
                    <div class="relative overflow-hidden bg-cover bg-no-repeat">
                      <img
                        src={result.image}
                        class={"w-full object-cover object-center h-80 rounded-t-lg relative " + borderColor[key % 3]}
                      />
                      <svg
                        class="absolute left-0 bottom-0"
                        viewBox="0 0 1440 320"
                      >
                        <path fill={color[key % 3]} d={path[key % 3]}></path>
                      </svg>
                    </div>
                    <div class={`${backgroundColor[key % 3]} rounded-b-lg`}>
